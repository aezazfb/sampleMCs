...
module.exports = {
	...
	plugins: [
		require('./src/theme-data/core/plugins/plugin'),
		require('./src/theme-data/core/plugins/components/theme'),
		require('./src/theme-data/core/plugins/components/breakpoints'),
		require('./src/theme-data/core/plugins/components/typography'),
		require('./src/theme-data/core/plugins/components/menu'),
		require('./src/theme-data/core/plugins/components/dropdown'),
		require('./src/theme-data/core/plugins/components/accordion'),
		require('./src/theme-data/core/plugins/components/input'),
		require('./src/theme-data/core/plugins/components/input-group'),
		require('./src/theme-data/core/plugins/components/select'),
		require('./src/theme-data/core/plugins/components/textarea'),
		require('./src/theme-data/core/plugins/components/file-input'),
		require('./src/theme-data/core/plugins/components/switch'),
		require('./src/theme-data/core/plugins/components/checkbox'),
		require('./src/theme-data/core/plugins/components/radio'),
		require('./src/theme-data/core/plugins/components/range'),
		require('./src/theme-data/core/plugins/components/container'),
		require('./src/theme-data/core/plugins/components/image-input'),
		require('./src/theme-data/core/plugins/components/modal'),
		require('./src/theme-data/core/plugins/components/drawer'),
		require('./src/theme-data/core/plugins/components/tooltip'),
		require('./src/theme-data/core/plugins/components/popover'),
		require('./src/theme-data/core/plugins/components/btn'),
		require('./src/theme-data/core/plugins/components/btn-group'),
		require('./src/theme-data/core/plugins/components/tabs'),
		require('./src/theme-data/core/plugins/components/pagination'),
		require('./src/theme-data/core/plugins/components/card'),
		require('./src/theme-data/core/plugins/components/table'),
		require('./src/theme-data/core/plugins/components/badge'),
		require('./src/theme-data/core/plugins/components/rating'),
		require('./src/theme-data/core/plugins/components/scrollable'),
		require('./src/theme-data/core/plugins/components/progress'),
		require('./src/theme-data/core/plugins/components/apexcharts'),
		require('./src/theme-data/core/plugins/components/leaflet')
	]
};
